...
;; Kristy Chen & Junhao Dong
;; Razzaq Fundamentals of CS I
...
(check-expect (can-move? (make-world (make-tetra (make-posn CENTER-X SIDELEN)
                                                 (list (make-block 0 0  "red")
                                                       (make-block 0 10 "red")
                                                       (make-block 0 20 "red")
                                                       (make-block 0 30 "red"))) empty) "left") false)
...
(check-expect (bset-rotate (tetra-center T-tetra) (tetra-blocks T-tetra) "ccw")
              (list (block-rotate (tetra-center T-tetra) (make-block X1 SIDELEN "orange") "ccw")
                    (block-rotate (tetra-center T-tetra) (make-block X2 0 "orange") "ccw")
                    (block-rotate (tetra-center T-tetra) (make-block X2 SIDELEN "orange") "ccw")
                    (block-rotate (tetra-center T-tetra) (make-block X3 SIDELEN "orange") "ccw")))
(check-expect (bset-rotate (tetra-center T-tetra) (tetra-blocks T-tetra) "cw")
              (list (block-rotate (tetra-center T-tetra) (make-block X1 SIDELEN "orange") "cw")
                    (block-rotate (tetra-center T-tetra) (make-block X2 0 "orange") "cw")
                    (block-rotate (tetra-center T-tetra) (make-block X2 SIDELEN "orange") "cw")
                    (block-rotate (tetra-center T-tetra) (make-block X3 SIDELEN "orange") "cw")))
...
;; restriction: String can only be cw or ccw for the direction it rotates
(check-expect (block-rotate (tetra-center T-tetra) (make-block X1 SIDELEN "orange") "ccw")
              (make-block (+ (posn-x (tetra-center T-tetra))
                          ...
                          "orange"))
(check-expect (block-rotate (tetra-center T-tetra) (make-block X1 SIDELEN "orange") "cw")
              (block-rotate (tetra-center T-tetra)
                            (block-rotate (tetra-center T-tetra)
                                            (block-rotate (tetra-center T-tetra) (make-block X1 SIDELEN "orange")  "ccw") "ccw") "ccw"))
...
(define testWorld3 (make-world (make-tetra (make-posn 200 200)  (list
